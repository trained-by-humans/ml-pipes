...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(list[Any], list[int], list[int], id="list[Any]-with-list[int]"),
        ...
        pytest.param(tuple[Any, str], tuple[int, Any], tuple[int, str], id="tuple[Any,str]-with-tuple[int,Any]"),
